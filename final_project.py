...
# Train a forecasting model on the normal data (can update input chunk length, output chunk length, as well as number
# of epochs)

# model = TCNModel(input_chunk_length=30, output_chunk_length=10, n_epochs=10, batch_size=8)

model = TCNModel.load("C:/Users/Hp/PycharmProjects/ECG-5000-Dataset_ML/TCN_Model.pth.tar")
