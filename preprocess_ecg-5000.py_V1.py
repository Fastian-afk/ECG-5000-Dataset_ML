...
print("Normal data count:", normal_data.shape[0])
print("Anomalous data count:", anomalous_data.shape[0])
...
print("Normal Validation data shape:", X_val_normal.shape)
print("Normal Test data shape:", X_test_normal.shape)

print("Anomalous Training data shape:", X_train_anomalous.shape)
print("Anomalous Validation data shape:", X_val_anomalous.shape)
print("Anomalous Test data shape:", X_test_anomalous.shape)

# Check the mean and standard deviation of the transformed data
print("Mean of the normal training data after normalization:")
print(np.mean(X_train_normal, axis=0))
print("Standard deviation of the normal training data after normalization:")
print(np.std(X_train_normal, axis=0))

print("Mean of the normal validation data after normalization:")
print(np.mean(X_val_normal, axis=0))
print("Standard deviation of the normal validation data after normalization:")
print(np.std(X_val_normal, axis=0))

print("Mean of the normal test data after normalization:")
print(np.mean(X_test_normal, axis=0))
print("Standard deviation of the normal test data after normalization:")
print(np.std(X_test_normal, axis=0))

print("Mean of the anomalous training data after normalization:")
print(np.mean(X_train_anomalous, axis=0))
print("Standard deviation of the anomalous training data after normalization:")
print(np.std(X_train_anomalous, axis=0))

print("Mean of the anomalous validation data after normalization:")
print(np.mean(X_val_anomalous, axis=0))
print("Standard deviation of the anomalous validation data after normalization:")
print(np.std(X_val_anomalous, axis=0))

print("Mean of the anomalous test data after normalization:")
print(np.mean(X_test_anomalous, axis=0))
print("Standard deviation of the anomalous test data after normalization:")
print(np.std(X_test_anomalous, axis=0))